...
OFFICIAL_SOURCES = [
    ...
    { "id": "SG_SFA_INITIAL", "name": "SFA Singapore - Initial Nestlé Stop-Sale Notice", "url": "https://www.sfa.gov.sg/news-publications/newsroom/direction-to-stop-sale-of-five-nestle-infant-formula-due-to-potential-presence-of-toxin-in-infant-formula", "date": "2026-01-08" },
    { "id": "SG_SFA_ADDITIONAL", "name": "SFA Singapore - Additional Recall Notice (Dumex/NAN)", "url": "https://www.sfa.gov.sg/news-publications/newsroom/direction-to-recall-additional-infant-formula-products-due-to-presence-of-cereulide-toxin", "date": "2026-01-17" },
