# 🍼 Nestlé Recall Checker (Global Edition)

> High-performance, bilingual (EN/CN) single-page web tool for the Global Nestlé Milk Formula Recall Search.

## 🚀 Live Demo
You can deploy this to GitHub Pages to see it live!
...
1. Create a new repository on GitHub named `nestle-recall-checker`.
...
---
*Created for public safety and transparency in infant nutrition.*
