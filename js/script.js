...
const I18N = {
    en: {
        ...
        disclaimer_title: "Strict License & Safety Notice",
        disclaimer_p1: "All content is licensed under CC BY-NC 4.0. Free to use for non-commercial safety purposes.",
        disclaimer_p2: "❌ NOTICE: Any charging for courses, subscriptions, or 'official services' related to ChinaOps is UNAUTHORIZED.",
        disclaimer_p3: "If you are asked to pay for this information, please reject and report the scam immediately.",
    ...
    zh: {
        ...
        disclaimer_title: "版权声明与安全协议",
        disclaimer_p1: "本工具内容基于 CC BY-NC 4.0 协议。免费供公共安全非商业用途使用。",
        disclaimer_p2: "❌ 严正声明：禁止任何形式的课件收费、会员订阅或冒充 ChinaOps 的付费服务。",
        disclaimer_p3: "如遇任何收费行为，请立即拒绝并向社区举报。本工具永久免费提供召回核对。",
